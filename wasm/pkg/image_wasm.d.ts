...
export function convert_image(input: Uint8Array, target_format: string): Uint8Array;

export function convert_image_with_options(input: Uint8Array, target_format: string, quality: number, max_width: number, max_height: number, lossless: boolean): Uint8Array;
